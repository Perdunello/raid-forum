        ...
        <div className={styles.midPart}>
            <div style={{backgroundColor: '#4d4c4c',borderRadius: '25px 25px 0 0',padding: '40px 20px'}}>
                ...
                <div style={{marginTop: '40px'}}><img
                    className={heroData.rarity === 'legendary'
                        ? styles.legendary
                        : heroData.rarity === 'epic'
                            ...
                            : heroData.rarity === 'rare'
                                ? styles.rare
                                : styles.common}
                    src={heroData.avatar_link} width={200} alt=""/></div>
                <div className={styles.mainInfo}>
                    <div className={styles.infoItemWrapper}>
                        <div className={styles.infoTitle}>Faction</div>
                        <div className={styles.infoItem}>
                            <div className={styles.imgWrapper}>
                                <img style={{margin: '10px 0'}} width={70} src={`/factions/${heroData.faction}.png`}
                                     alt=""/>
                            </div>
                    ...
                    <div className={styles.infoItemWrapper}>
                        ...
                        <div className={styles.infoItem}>
                            <div className={styles.imgWrapper}>
                                <img style={{margin: '10px 0'}} width={50} src={`/affinities/${heroData.affinity}.png`}
                                     alt=""/>
                            </div>
                    ...
                    <div className={styles.infoItemWrapper}>
                        ...
                        <div className={styles.infoItem}>
                            <div className={styles.imgWrapper}>
                                <img style={{margin: '10px 0'}} width={50} src={`/rarity/${heroData.rarity}.png`}
                                     alt=""/>
                            </div>
                    ...
                    <div className={styles.infoItemWrapper}>
                        ...
                        <div className={styles.infoItem}>
                            <div className={styles.imgWrapper}>
                                <img style={{margin: '10px 0'}} width={50} src={`/role/${heroData.role}.png`} alt=""/>
                            </div>
                            <div>{heroData.role}</div>
                        </div>
                    </div>
                </div>
                <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus aliquid amet, animi aperiam architecto at debitis deleniti doloribus enim impedit, in laboriosam, minima molestias numquam odio provident recusandae sunt tenetur velit vitae. Aut commodi eligendi fuga hic labore molestias mollitia, ratione reiciendis sed. Accusantium blanditiis deleniti dicta impedit in inventore iusto magnam nostrum obcaecati officiis optio praesentium sit tempora, tenetur veniam, voluptatem voluptatibus. Ab accusamus aperiam autem blanditiis deleniti dignissimos dolor ducimus earum, est et inventore itaque labore laborum laudantium maiores minus modi nihil, non numquam obcaecati optio pariatur quasi quos saepe soluta suscipit tempore. Ab blanditiis nam officia repellendus.</div>
            </div>
        </div>
            ...
            {heroData.skills.map(skill => {
                return <div key={skill.id} className={styles.skills}>
                    <div>
                        ...
                        <img className={skill.cooldown !== 'Aura' ? styles.skillSimple : styles.skillAura}
                             src={skill.image_link} alt=""/>
